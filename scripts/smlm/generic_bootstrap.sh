...
echo "PROFILENAME ${PROFILENAME} ACTIVATION_KEYS=${ACTIVATION_KEYS} ORG_GPG_KEY=${ORG_GPG_KEY} SMLM_DNS=${SMLM_DNS} HOSTNAME=${HOSTNAME:-mlm-server.geeko.land} REACTIVATION_KEY=${REACTIVATION_KEY} CLIENT_OVERRIDES=${CLIENT_OVERRIDES:-client-config-overrides.txt} ORG_CA_CERT=${ORG_CA_CERT:-RHN-ORG-TRUSTED-SSL-CERT} USING_SSL=${USING_SSL:-1} USING_GPG=${USING_GPG:-1}"
